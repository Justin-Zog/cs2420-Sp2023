...
public class AVLTree<AnyType extends Comparable<? super AnyType>>
{
     ...
     * deleted from the subtree rooted at t
     */
   private AvlNode<AnyType> deleteMin( AvlNode<AnyType> t )
   {
       if (t == null || t.left == null) return t.right;

       AvlNode<AnyType> original_t = t;

       while (t.left.left != null ) t = t.left;

       t.left = t.left.right;

       return balance(original_t);
    }
